...
- 11 AI agents
- Split into TWO funnels (the MHSP method)
- 1 captain (the hotel manager)
- Output: leads + emails + proposals + follow-ups, every day

### The dual funnel visual
| 🎯 CALCULATED FUNNEL | ⚡ HUSTLE FUNNEL |
|---|---|
| Big revenue, top accounts | Local, grassroots, backyard |
| 6 agents | 5 agents |
| Director, Outbound, RFP, LNR, Account Manager, Revenue Leadership | Backyard Hunter, Group Sales, M&C, After-Sales, Retention |
...
2. Show the Westmore Hotel Dallas profile (pre-loaded)
3. Click "Generate Sales Team" → 11 agents appear in two funnels
4. Open Director of Sales chat → live conversation streams in
5. Ask: "Plan our week to attack weekday occupancy"
6. Stream the response showing dual-funnel priorities
7. Open Backyard Hunter (Lead Gen) → "Find 10 medical leads"
8. Streaming list of Texas Health, UT Southwestern, etc.
9. Open No-Fear Closer (Outbound) → "Write to the top 3"
10. Streaming personalized cold emails
11. Click "Send Email" → modal → queue to Inntelligent CRM
12. Open myConcierge (bottom-right) → "What's the best agent for 
    backyard hustle?" → live streaming response

### Key narration line during demo
> "Everything you're seeing is real. Real Claude API. Real Westmore 
> data. Real outputs your sales team could send tomorrow morning."
...
- Joined by Nirav from Monday for polish
- Live URL: virtual-hotel-sales-team.vercel.app
- 100+ commits in 4 days
- Stack: Next.js 15, Claude Sonnet 4.6, Vercel
- All 11 agents wired with skill-based architecture
...
by the human captain before sending. We're a co-pilot, not a 
replacement.
...
A: Hotel data lives in your tenant. Anthropic doesn't train on API 
data by default. Enterprise tier available with zero data retention.

**Q: Pricing?**
A: $99/property/month, billed annually. First 10 hotels: Founding 
