  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-8">
      ...
      >
        ...
        <span
          className={`absolute top-4 left-24 inline-flex items-center gap-1 rounded-full px-2 py-1 text-[10px] font-bold tracking-[0.14em] uppercase ${
            isCalculated
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[35%_65%] gap-6">
        ...
        <aside>
          <div className="bg-white rounded-2xl border border-mhsp-line p-6 shadow-[0_2px_10px_-4px_rgba(11,36,71,0.06)]">
            ...
            <p className="text-[11px] font-semibold tracking-[0.16em] uppercase text-mhsp-gold mt-1">
              {agent.roleTitle}
            </p>
