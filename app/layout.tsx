...
export const metadata: Metadata = {
  ...
  description:
    "The MHSP dual sales funnel - calculated + hustle - built into 6 AI sales agents. Explosive revenues for hotels, without fear. Powered by My Hospitality Sales Pro & Inntelligent CRM.",
  keywords: [
    "hotel sales",
    "AI sales",
    "MHSP",
  ...
  openGraph: {
    ...
    description:
      "The MHSP dual sales funnel - calculated + hustle - built into 6 AI sales agents. Explosive revenues for hotels, without fear.",
  ...
  twitter: {
    ...
    title: "my Sales TEAM AI · Synergistic Selling on Autopilot",
    description:
      "The MHSP dual funnel - calculated + hustle - built into 6 AI sales agents. Explosive revenues. No fear.",
  },
};
